...
#define HALL_TIMx                        TIM2
#define HALL_TIM_RCC_CLK_ENABLE()        __HAL_RCC_TIM2_CLK_ENABLE()

#define HALL_TIM_GPIO_AF                 GPIO_AF1_TIM2
...
#define HALL_TIM_IRQHanler               TIM2_IRQHandler
